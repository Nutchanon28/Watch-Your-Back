...
for i in range(max_number_of_enemies):
    e = Enemy(random.randint(0, 800), 480, global_speed * -
              1.8, global_speed * -1.8, pygame.image.load('enemy_left.png'), "dead", i, 4, True)
    enemies.append(e)
...
for i in range(number_of_bullets):
    b = Bullet(4200, 4200, global_speed * 10, 0,
...
def jump_down():
    ...
    if playerY >= 480:
        ...
        player_onplatformlayer = 1
    elif playerY <= 116 + 10 and playerX >= 190 and playerX <= 374:
        player_onplatformlayer = 2
    elif playerY <= 116 + 10 and playerX >= 570 and playerX <= 694:
        player_onplatformlayer = 2
